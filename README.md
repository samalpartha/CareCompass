...
- **Working Demo:** [https://samalpartha.github.io/CareCompass/](https://samalpartha.github.io/CareCompass/)
- **Project Description:** You're reading it! This README provides a comprehensive overview of the project.
- **Demo Video (3-5 mins):** `[Link to your demo video]`
- **GitHub Repository:** The code for this project is available in this repository.
...
- **Framework:** [Next.js](https://nextjs.org/) (with App Router & Static Export)
...
- `src/ai/`: Houses the logic for interacting with the AI model.
